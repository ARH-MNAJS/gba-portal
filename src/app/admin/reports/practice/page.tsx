...
export default function PracticeReportsBasePage() {
      ...
      try {
        ...
        const collegesList = await Promise.all(collegesSnapshot.docs.map(async (doc) => {
          ...
          if (collegeData.college && 
              typeof collegeData.college === 'string' && 
              collegeData.college.trim() !== '') {
            try {
  ...
  if (loading) {
    return (
      <div className="container mx-auto py-6 space-y-6">
        <h1 className="text-2xl font-bold">Practice Reports</h1>
